...
const app = express()
const { getUsers, getUsersByUsername, getPostsByMap, getPostById, postNewPost, getUserFavourites, postUserFavourites, getAllPosts, patchUser, deletePost, deleteFavourite } = require(`./controllers/controllers`)
